...
const Header = () => {
  return (
    <header className='relative overflow-hidden rounded-2xl h-[380px] sm:h-[430px] lg:h-[480px]'>
      {/* Background image */}
      <img src={assets.header_img} alt="Doctors" className="w-full h-full object-cover" />

      {/* left side */}
      <div className="absolute left-6 sm:left-10 lg:left-16 top-1/2 -translate-y-1/2 max-w-xs sm:max-w-sm lg:max-w-md text-primary-700 font-semibold">
